...
class URL:
    def __init__(self, url):
        self.scheme, url = url.split("://",1) #"http://google.com"->["http", "google.com"].
        # print(self.scheme)
        assert self.scheme in ["http","https"]   #if assert fails -> program stops there
    ...
    def request(self):
        ...
        if self.scheme == "https":
            ctx = ssl.create_default_context() #default may cause issue in some cases
